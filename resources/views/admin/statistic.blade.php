 @include('admin.layouts.sidebar')
  ...
  <div class="pusher" style="margin-right:350px">
    <h1 class="ui center aligned header" >Thống kê</h1>
    <br>
...
<div class="wrap" style="transform: scale(1.3);margin-top: 200px;margin-left: 150px;">
